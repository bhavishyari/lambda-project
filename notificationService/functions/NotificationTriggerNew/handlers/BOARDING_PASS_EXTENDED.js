...
/**
 * handle notifications for BOARDING_PASS_EXTENDED event
 * event source: boarding_pass update
 * TARGET USER: rider
 * SES TEMPLATE: BOARDING_PASS_EXTENDED
 * 
 * @param {String} trigger
 * @param {Object} event 
 */
const BOARDING_PASS_EXTENDED = async (trigger, event) => {

  let Template = 'BOARDING_PASS_EXTENDED',
    ...
    notificationList['emails'] = [
      {
        ...
        TemplateData: {
            ...
            qr_code_url: qrUrl,
            extended_days: evt.extended_details.days
        }
      }
    ];
  }
  ...
  pushMsg = {
    title: 'Your boarding pass extended',
    body: `Your boarding pass ${passNoPadZero} started  on ${validFrom} has  been extended.`
  };
  ...
  console.log('BOARDING_PASS_EXTENDED : sqsResult : ', JSON.stringify(sqsResult));

}

module.exports = BOARDING_PASS_EXTENDED;
