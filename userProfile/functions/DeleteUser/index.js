...
module.exports.handler = async event => {
    try {
        ...
        let current_user_id = body.session_variables['x-hasura-user-id'];
        ...
        /**
         * Allow admin and current user to hard delete users
         */
        ...
        /**
         * Soft Delete user from Hasura
         */
         let user = await DeleteHasuraUser(user_id);
